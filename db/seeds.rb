...
LogEntry.create(surf_spot: "Pipeline", swell_size: "Double Overhead", swell_direction: "Northwest", conditions: "Clean", wave_count: "20-30", content: "What can I say? Best waves of my life? Always trying to get that epic sesh!", image_url: "/images/pipeline.jpg", date: "winter '05", surfer_id: 3)
LogEntry.create(surf_spot: "Lower Trestles", swell_size: "", swell_direction: "", conditions: "", wave_count: "", content: "It got really packed! Even though I'm the most famous surfer in the world I still have to fight for waves!", image_url: "/images/trestles.jpg", date: "November 10, 2016", surfer_id: 3)
LogEntry.create(surf_spot: "Surf Ranch", swell_size: "", swell_direction: "", conditions: "Mechanical", wave_count: "", content: "Sometimes you just have to build the perfect wave and fense it in to get waves to yourself.", image_url: "/images/surfranchkellyslater.jpg", date: "any day", surfer_id: 3)
...
LogEntry.create(surf_spot: "Morro Bay @ the rock'", swell_size: "Head high", swell_direction: "", conditions: "", wave_count: "a ton", content: "I had to give a hard stare to all the kooks in the water that day so they wouldn't try to burn me!", image_url: "/images/mikesurf4.jpg", date: "December, 21st 2012", surfer_id: 13)
